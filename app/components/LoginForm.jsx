    ...
    <form action={login} className="flex-col  rounded-xl p-10 justify-center bg-base-200">
      <h1 className="text-2xl mb-10 text-center">Login to LooQuiz</h1>
        ...
        <label className="form-control w-full max-w-xs">
            ...
            <input id="email" name="email" type="text" placeholder="looquiz11@gmail.com" className="input input-bordered w-full" />
            <div className="label">
        ...
        <label className="form-control w-full max-w-xs">
            ...
            <input id="password" name="password" type="password" placeholder="***" className="input input-bordered w-96 max-w-xs" />
            <div className="label ">
                <span className="label-text-alt text-error">Error here</span>
            </div>
        </label>
